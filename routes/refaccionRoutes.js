...
router.get('/obtenerTodas/:sucursal', refaccionController.obtenerTodasS.bind(refaccionController));
router.get('/obtenerTodasS', refaccionController.obtenerTodasS.bind(refaccionController));
